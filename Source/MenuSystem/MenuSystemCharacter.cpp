...
void AMenuSystemCharacter::CreateGameSession()
{
	...
	{
		OnlineSessionInterface->DestroySession(NAME_GameSession); // Destroy the session if it already exists
	}
    ...
    SessionSettings->bUseLobbiesIfAvailable = true; // Use the lobbies if available, I also help me to close and open them.
